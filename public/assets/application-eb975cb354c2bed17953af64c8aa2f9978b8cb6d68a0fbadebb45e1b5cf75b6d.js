...
$(function() {
  ...
  let rules = {
    ...
    'post[skills_attributes][0][name]': { required: true, maxlength: 15 },
    'post[skills_attributes][1][name]': { required: true, maxlength: 15 },
    'post[skills_attributes][2][name]': { required: true, maxlength: 15 },
    'post[skills_attributes][3][name]': { maxlength: 15 },
    'post[skills_attributes][4][name]': { maxlength: 15 },
  ...
  let messages = {
    ...
    'post[skills_attributes][0][name]': { required: "スキル1を入力してください", maxlength: "スキル1の最大文字数は15文字までです" },
    'post[skills_attributes][1][name]': { required: "スキル2を入力してください", maxlength: "スキル2の最大文字数は15文字までです" },
    'post[skills_attributes][2][name]': { required: "スキル3を入力してください", maxlength: "スキル3の最大文字数は15文字までです" },
    'post[skills_attributes][3][name]': { maxlength: "スキル4の最大文字数は15文字までです" },
    'post[skills_attributes][4][name]': { maxlength: "スキル5の最大文字数は15文字までです" },
...
// from application.js or material_kit.js. Let say if you have 3 feature init
